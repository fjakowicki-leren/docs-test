<div class="js-accordion-container{% if store.branches|length > 1 %} js-toggle-branches{% endif %}">
    <div class="font-smallest my-2">
        {% include "snipplets/svg/store.tpl" with {svg_custom_class: "icon-inline icon-lg icon-w svg-icon-text mr-2"} %}
    ...
    {% if store.branches|length > 1 %}
        <a href="#" class="js-accordion-toggle btn-link font-small pl-1">
